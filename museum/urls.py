...
from . import views
from .seo import google_site_verification, robots_txt, sitemap_xml
...
urlpatterns = [
    ...
    path('google0efda1dccc19138d.html', google_site_verification, name='google_site_verification'),
